...
# 初始化DeepSeek官方API客户端
client = OpenAI(base_url="https://api.moonshot.cn/v1", api_key="sk-r4RmRqkFawE8iIMvGFgmT6CGlkP5O6jyk45mekjWBzeP8ewH")
...
if __name__ == "__main__":
    batch_process_with_eval(
        ...
        output_folder=r"D:\研究生\项目组\科研\小模型+RAG暑期实验\50个含教学环节名称的教案\txt教案\测试结果\大模型测试结果",
