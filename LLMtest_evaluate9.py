...
# ================= 配置区域 =================
MODELS = {
    #"DeepSeek-R1Distill-Qwen-1.5B": "/home/lhr/7Bmodel/DeepSeek-R1-Distill-Qwen-1.5B",
...
if __name__ == "__main__":
    batch_process_with_eval(
        ...
        output_folder=r"D:\研究生\项目组\科研\小模型+RAG暑期实验\50个含教学环节名称的教案\txt教案\测试结果\有指标\（增强prompt）测试结果2_删去环节名称并打乱顺序\评估指标9",
