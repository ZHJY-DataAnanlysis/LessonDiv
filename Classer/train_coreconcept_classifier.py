# train_coreconcept_classifier.py
import jsonlines
import pandas as pd
...
# ---------- 2. 只保留“核心概念”单标签 ----------
df['label'] = df['label'].str.split('|').str[2]          # 第三段
...
# ---------- 6. 保存 ----------
joblib.dump(pipe, r"D:\Python\PythonProject\LLM_division_of_teaching_links\分类模型\无环节乱序训练\决策树\coreconcept_classifier_cls.pkl")
print("模型已保存为 coreconcept_classifier_cls.pkl")