# train_lessontype_classifier.py
import jsonlines
import pandas as pd
...
# ---------- 2. 只保留“课型”单标签 ----------
df['label'] = df['label'].str.split('|').str[1]          # 第二段
...
# ---------- 6. 保存 ----------
joblib.dump(pipe, r"D:\Python\PythonProject\LLM_division_of_teaching_links\分类模型\无环节乱序训练\决策树\lessontype_classifier_cls.pkl")
print("模型已保存为 lessontype_classifier_cls.pkl")